...
class API {
  ...
  void getTodayPlay(RequestCallBack requestCallBack) async {
    ...
    List<String> todyUrls = [];
    todyUrls.add(list[0].images?.medium);
    todyUrls.add(list[1].images?.medium);
    todyUrls.add(list[2].images?.medium);
    ...
    requestCallBack({'list': todyUrls, 'todayPlayBg': todayPlayBg});
  }
}
